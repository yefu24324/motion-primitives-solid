...
export const Tabs = <T extends ValidComponent = "div">(props: TabsProps<T>) => {
  ...
  return <TabsPrimitive class={cx("flex flex-col gap-2", "data-[orientation=vertical]:flex-row", props.class)} data-slot="tabs" {...rest} />;
};
...
export const TabsContent = <T extends ValidComponent = "div">(props: TabsContentProps<T>) => {
  ...
  return <TabsPrimitive.Content class={cx("flex-1 outline-none", props.class)} data-slot="tabs-content" {...rest} />;
};
