...
export const Tabs = <T extends ValidComponent = "div">(props: TabsProps<T>) => {
  ...
  return <TabsPrimitive data-slot="tabs" class={cx("flex flex-col gap-2", "data-[orientation=vertical]:flex-row", props.class)} {...rest} />;
};
...
export const TabsContent = <T extends ValidComponent = "div">(props: TabsContentProps<T>) => {
  ...
  return <TabsPrimitive.Content data-slot="tabs-content" class={cx("flex-1 outline-none", props.class)} {...rest} />;
};

export type TabsIndicatorProps<T extends ValidComponent = "div"> = ComponentProps<typeof TabsPrimitive.Indicator<T>>;
