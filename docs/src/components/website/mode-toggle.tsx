...
const ModeToggle = () => {
  ...
  return (
    <Button onClick={toggleColorMode} size="icon" variant="ghost">
      <svg class="hidden size-4 [html[data-kb-theme=dark]_&]:block" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path
      ...
      <svg class="hidden size-4 [html[data-kb-theme=light]_&]:block" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path
