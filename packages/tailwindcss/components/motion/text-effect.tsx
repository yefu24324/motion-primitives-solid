...
import { For, type JSX, Match, mergeProps, Show, Switch, type ValidComponent } from "solid-js";
...
export function AnimationComponent(props: { segment: string; variants: Variants; per: PerType; segmentWrapperClassName?: string }) {
  return (
    <Switch>
      <Match when={props.per === "line"}>
        <Motion as="span" class="block" variants={props.variants}>
          {props.segment}
        </Motion>
      </Match>
      <Match when={props.per === "word"}>
        <Motion aria-hidden="true" as="span" class="inline-block whitespace-pre" variants={props.variants}>
          {props.segment}
        </Motion>
      </Match>
      <Match when={props.per === "char"}>
        <Motion as="span" class="inline-block whitespace-pre">
